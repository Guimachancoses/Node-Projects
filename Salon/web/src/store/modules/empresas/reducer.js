  ...
  switch (action.type) {
    ...
    case types.FILTER_EMPRESAS_REQUEST:
      return {
        ...state,
        error: null,
        form: { ...state.form, filtering: true },
      };
    ...
    case types.UPDATE_EMPRESA_SUCCESS:
      return {
        ...
        components: { ...state.components, drawer: false },
      };

    case types.DELETE_EMPRESA_SUCCESS:
      return {
        ...state,
        empresas: state.empresas.filter((e) => e._id !== action.payload),
        form: { ...state.form, saving: false },
      };
    ...
    case types.SET_EMPRESA:
      return {
        ...
        behavior: action.payload?._id ? "update" : "create",
      };
